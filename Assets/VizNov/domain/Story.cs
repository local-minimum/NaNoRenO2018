...
namespace VizNov.Domain
{
    static class JsonHelper
    {
        ...
        public static Character[] GetCharacters(string characters)
        {
            return LoadArr(characters).Select(e => Character.LoadFromJSON(e)).ToArray();
        }
    } 
    ...
    public struct Story
    {
        ...
        public Story(Dictionary<string, string> tmp)
        {
            ...
            _characters = JsonHelper.GetCharacters(characters);
        }

        public static Story LoadFromJSON(string json)
        {
            return new Story(JsonHelper.LoadObject(json));
        }
    }
}
